...
var orm = {
    all: function(tableInput, cb) {
        ...
        var queryString = "SELECT playersadvanced.Rk, playersadvanced.Player, ROUND((playersadvanced.MP/G)*(playersadvanced.USGP)*(playersadvanced.PER/4 + playersadvanced.TSP/3 + playersadvanced.3PAR/4 + playersadvanced.FTR/4 + playersadvanced.TRBP/3 + playersadvanced.ASTP/3 + playersadvanced.STLP/4 + playersadvanced.BLKP/4 - playersadvanced.TOVP/4) + 100*(playersadvanced.OWS + playersadvanced.DWS/2 + playersadvanced.WS + playersadvanced.WS48) + 20*(playersadvanced.OBPM + playersadvanced.DBPM/2 + playersadvanced.BPM + playersadvanced.VORP), 1) AS rawAdv, october2018.gameid FROM playersadvanced LEFT JOIN october2018 ON playersadvanced.RK WHERE playersadvanced.Rk=october2018.gameid LIMIT 50"
